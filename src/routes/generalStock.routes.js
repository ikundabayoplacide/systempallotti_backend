...
router.get('/items', authorize('ADMIN', 'STOCK', 'DAF', 'HOBE', 'PRODUCTION_MANAGER', 'WORKER', 'SUPERVISOR', 'RECEPTIONIST'), ctrl.getAllItems);
router.get('/items/:id', authorize('ADMIN', 'STOCK', 'DAF', 'HOBE', 'PRODUCTION_MANAGER', 'WORKER', 'SUPERVISOR', 'RECEPTIONIST'), ctrl.getItemById);
