...
router.get('/items', authorize('ADMIN', 'SUPERVISOR', 'DAF', 'WORKER', 'PRODUCTION_MANAGER', 'RECEPTIONIST'), ctrl.getAllItems);
router.get('/items/:id', authorize('ADMIN', 'SUPERVISOR', 'DAF', 'WORKER', 'PRODUCTION_MANAGER', 'RECEPTIONIST'), ctrl.getItemById);
...
// Entries (IN)
router.get('/entries', authorize('ADMIN', 'SUPERVISOR', 'DAF', 'PRODUCTION_MANAGER'), ctrl.getAllEntries);
...
router.get('/sorties', authorize('ADMIN', 'SUPERVISOR', 'DAF', 'PRODUCTION_MANAGER'), ctrl.getAllSorties);
router.get('/sorties/:id', authorize('ADMIN', 'SUPERVISOR', 'DAF', 'PRODUCTION_MANAGER'), ctrl.getSortieById);
