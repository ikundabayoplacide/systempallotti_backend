...
class BindingStockSortie extends Model {}

BindingStockSortie.init(
  {
  ...
  { sequelize, modelName: 'BindingStockSortie', tableName: 'binding_stock_sorties', timestamps: true }
);

module.exports = BindingStockSortie;
