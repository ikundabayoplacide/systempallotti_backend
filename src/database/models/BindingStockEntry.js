...
class BindingStockEntry extends Model {}
...
BindingStockEntry.init(
  ...
  { sequelize, modelName: 'BindingStockEntry', tableName: 'binding_stock_entries', timestamps: true }
);

module.exports = BindingStockEntry;
