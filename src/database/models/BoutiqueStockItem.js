...
class BoutiqueStockItem extends Model {
  get stockStatus() {
...
BoutiqueStockItem.init(
  ...
  { sequelize, modelName: 'BoutiqueStockItem', tableName: 'boutique_stock_items', timestamps: true }
);

module.exports = BoutiqueStockItem;
