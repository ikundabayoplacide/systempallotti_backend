...
class GeneralStockEntry extends Model {}

GeneralStockEntry.init(
  {
  ...
  { sequelize, modelName: 'GeneralStockEntry', tableName: 'general_stock_entries', timestamps: true }
);

module.exports = GeneralStockEntry;
