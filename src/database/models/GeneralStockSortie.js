...
class GeneralStockSortie extends Model {}

GeneralStockSortie.init(
  {
  ...
  { sequelize, modelName: 'GeneralStockSortie', tableName: 'general_stock_sorties', timestamps: true }
);

module.exports = GeneralStockSortie;
